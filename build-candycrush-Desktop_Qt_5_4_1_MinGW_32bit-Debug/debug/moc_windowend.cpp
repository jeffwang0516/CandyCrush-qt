...
#include "../../candycrush/windowend.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_windowEnd_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_windowEnd_t qt_meta_stringdata_windowEnd = {
    {
QT_MOC_LITERAL(0, 0, 9), // "windowEnd"
QT_MOC_LITERAL(1, 10, 6), // "endSig"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 7) // "onclick"

    },
    "windowEnd\0endSig\0\0onclick"
};
...
void windowEnd::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (windowEnd::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&windowEnd::endSig)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject windowEnd::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_windowEnd.data,
...
void *windowEnd::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_windowEnd.stringdata))
