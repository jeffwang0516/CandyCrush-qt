...
public:
    ...
    void setupUi(QDialog *windowEnd)
    {
        ...
        label->setGeometry(QRect(170, 80, 501, 101));
        label->setStyleSheet(QLatin1String("font: 75 40pt \"Snap ITC\";\n"
"color: rgb(255, 0, 4);"));
        label_2 = new QLabel(windowEnd);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(190, 300, 431, 101));
        label_2->setStyleSheet(QLatin1String("font: 50pt \"Poor Richard\";\n"
"color: rgb(33, 140, 255);"));
        label_3 = new QLabel(windowEnd);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(200, 480, 441, 111));
